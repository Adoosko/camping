...
export const buttons = [
  ...
  // },
  {
    ...
    showDot: false,
    component: (
      <button className="relative w-[200px] inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        <span
